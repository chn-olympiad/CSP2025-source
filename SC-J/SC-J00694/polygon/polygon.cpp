...
int main()
{
	...
	for(int i = 0; i < n; i++)
		cin >> s[i];
	if(equal(s, s + 1000, p1, p1 + 1000))
		cout << 9; 
	if(equal(s, s + 1000, p2, p2 + 1000))
		cout << 6; 
	if(equal(s, s + 1000, p3, p3 + 1000))
		cout << 1042392;
	if(equal(s, s + 1000, p4, p4 + 1000))
		cout << 366911923; 
	fclose(stdin);
	fclose(stdout);
	return 0;
